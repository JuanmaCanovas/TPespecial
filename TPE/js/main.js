document.getElementById("work1").addEventListener("mouseover", cambiarPastWork1);
function cambiarPastWork1 (){
    let img = document.getElementById("work1");
    img.src = "assets/pastworks1hov.PNG";
}
document.getElementById("work1").addEventListener("mouseout", original1);
function original1 (){
    let img = document.getElementById("work1");
...
document.getElementById("work3").addEventListener("mouseover", cambiarPastWork3);
function cambiarPastWork3 (){
    let img = document.getElementById("work3");
    img.src = "assets/pastworks3hov.PNG";
}
document.getElementById("work3").addEventListener("mouseout", original3);
function original3 (){
    let img = document.getElementById("work3");
    img.src = "assets/pastworks3.PNG";
}
